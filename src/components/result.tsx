        ...
        <div className="flex-1">
          ...
          <div className="grid grid-cols-2 gap-4 mt-6">
            <div className="flex items-center">
              <img src="src/assets/icon-location.svg" alt="Location Icon" className="w-5 h-5 mr-2" />
              <span>{userData.location || "Not Available"}</span>
            </div>
            <div className="flex items-center">
              <img src="src/assets/icon-twitter.svg" alt="Twitter Icon" className="w-5 h-5 mr-2" />
              <span>{userData.twitter_username ? `@${userData.twitter_username}` : "Not Available"}</span>
            </div>
            <div className="flex items-center">
              <img src="src/assets/icon-website.svg" alt="Website Icon" className="w-5 h-5 mr-2" />
              <a href={userData.blog} className="text-blue-500 truncate" target="_blank" rel="noopener noreferrer">
                {userData.blog || "Not Available"}
              </a>
            </div>
            <div className="flex items-center">
              <img src="src/assets/icon-company.svg" alt="Company Icon" className="w-5 h-5 mr-2" />
